...
<body> 
	...
	<div></div>
	<input type="button" value="목록" onclick="location.href='http://localhost:8083/adlist'" class="btn btn-secondary"></input>
	<c:if test="${signIn.user_id == '관리자'}">
	<input type="button" value="수정" onclick="location.href='http://localhost:8083/adupdate?adbNum=${adbNum}'" class="btn btn-secondary"></input>
